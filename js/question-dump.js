const bibleTriviaQuestions = [
  ...
  {
    "question": "In the story of the Good Samaritan, who of the following passed by the injured man before the Samaritan helped him?",
    "options": ["Priest", "Sadducee", "Pharisee", "Scribe"],
    "answer": "Priest"
  },
  {
  ...
  {
    "question": "Who was the shortest man mentioned in the Bible?",
    "options": ["Zacchaeus", "Nehemiah", "Bartimaeus", "Joel"],
    "answer": "Zacchaeus"
  },
  {
    "question": "Which prophet was fed by ravens during a time of drought?",
    "options": ["Elijah", "Elisha", "Jonah", "Isaiah"],
    "answer": "Elijah"
  },
  {
    "question": "What was the name of the magician who opposed Moses during the Exodus?",
    "options": ["Jannes", "Bartimaeus", "Balaam", "Barak"],
    "answer": "Jannes"
  },
  {
    "question": "Which apostle was also known as Didymus?",
    "options": ["Philip", "Thomas", "Bartholomew", "James"],
    "answer": "Thomas"
  },
  {
    "question": "In the book of Esther, what was the name of Mordecai's cousin who became queen?",
    "options": ["Ruth", "Hannah", "Esther", "Abigail"],
    "answer": "Esther"
  },
  {
    "question": "Which judge of Israel had seventy sons?",
    "options": ["Gideon", "Jephthah", "Samson", "Abdon"],
    "answer": "Gideon"
  },
  {
    "question": "What was the name of the angel who appeared to Zechariah to announce the birth of John the Baptist?",
    "options": ["Michael", "Raphael", "Uriel", "Gabriel"],
    "answer": "Gabriel"
  },
  {
    "question": "Which Old Testament prophet used an iron axhead that miraculously floated in the water?",
    "options": ["Elisha", "Hosea", "Joel", "Elijah"],
    "answer": "Elisha"
  },
  {
  ...
  {
    "question": "Which Old Testament character, known for his strength, killed a lion with his bare hands?",
    "options": ["Samson", "Gideon", "Ehud", "Shamgar"],
    "answer": "Samson"
  },
  {
    "question": "In the book of Judges, which woman killed Sisera with a tent peg?",
    "options": ["Deborah", "Jael", "Huldah", "Athaliah"],
    "answer": "Jael"
  },
  {
    "question": "Which king in the Old Testament had a throne with lions on each side?",
    "options": ["Solomon", "Hezekiah", "Rehoboam", "Josiah"],
    "answer": "Solomon"
  },
  {
  ...
  },
  {
    ...
    "options": ["Hosea", "Micah", "Amos", "Zechariah"],
    "answer": "Hosea"
  },
  {
    "question": "Which Old Testament character was known for having a talking donkey?",
    "options": ["Balaam", "Balak", "Beor", "Zippor"],
    "answer": "Balaam"
  },
  {
    "question": "In the book of Esther, what was the name of the man who built a gallows to hang Mordecai but ended up being hanged himself?",
    "options": ["Haman", "Zeresh", "Harbonah", "Memucan"],
    "answer": "Haman"
  },
  {
    "question": "In the New Testament, which city did Paul visit where the people worshiped the 'unknown god'?",
    "options": ["Athens", "Corinth", "Ephesus", "Thessalonica"],
    "answer": "Athens"
  },
  {
    "question": "Which Old Testament character had a dream of a ladder reaching to heaven with angels ascending and descending?",
    "options": ["Jacob", "Abraham", "Isaac", "Joseph"],
    "answer": "Jacob"
  },
  {
    "question": "What prophet anointed Jehu as king of Israel?",
    "options": ["Elijah", "Elisha", "Amos", "Hosea"],
    "answer": "Elisha"
  },
  {
    "question": "How did Jehu kill King Joram of Israel?",
    "options": ["Arrow", "Sword", "Poison", "Fire"],
    "answer": "Arrow"
  },
  {
    "question": "What was the name of Jehu's grandfather?",
    "options": ["Omri", "Ahab", "Nimshi", "Zimri"],
    "answer": "Nimshi"
  },
  {
    "question": "In addition to being king of Israel, Jehu also became the exterminator of the house of which wicked queen?",
    "options": ["Athaliah", "Jezebel", "Herodias", "Vashti"],
    "answer": "Jezebel"
  },
  {
    "question": "Jehu's zeal for the Lord led him to destroy the worshipers of which false god?",
    "options": ["Baal", "Ashtoreth", "Molech", "Dagon"],
    "answer": "Baal"
  },
  {
    "question": "How did Jehu deceive the prophets of Baal before destroying them?",
    "options": ["Feigned alliance", "Offered them riches", "Pretended conversion", "Hosted a banquet"],
    "answer": "Feigned alliance"
  },
  {
    "question": "What did Jehu say to Jehonadab when he invited him to ride in his chariot?",
    "options": ["Come, see my zeal for the Lord", "Follow me into battle", "Witness the power of the Lord", "Join me in worship"],
    "answer": "Come, see my zeal for the Lord"
  },
  {
    "question": "How long did Jehu reign as king of Israel?",
    "options": ["12 years", "18 years", "28 years", "30 years"],
    "answer": "28 years"
  },
  {
    "question": "Jehu's dynasty came to an end with the reign of which king?",
    "options": ["Joash", "Zechariah", "Jehoash", "Jeroboam II"],
    "answer": "Zechariah"
  },
  {
    "question": "What was the name of the land Caleb specifically wanted as his inheritance?",
    "options": ["Hebron", "Jericho", "Canaan", "Gaza"],
    "answer": "Hebron"
  },
  {
    "question": "Who was Caleb's father?",
    "options": ["Jephunneh", "Kenaz", "Hepher", "Zelophehad"],
    "answer": "Jephunneh"
  },
  {
  ...
  {
    "question": "Which city is symbolically called 'Babylon the Great' in the book of Revelation?",
    "options": ["Rome", "Jerusalem", "Babylon", "Ephesus"],
    "answer": "Rome"
  },
  {
